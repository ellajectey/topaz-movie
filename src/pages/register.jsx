...
function Register(props) {
  return (
    <>
      ...
      <div className="text-white h-[100vh] flex justify-center items-center content-center bg-cover bg-[url('./assets/images/register-bg.jpg')]">
        <div className=" justify-center content-center bg-slate-800 border border-slate-400 rounded-md p-12 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative">
          <h1 className="text-xl  py-4 items-center" >Register Page</h1>
          ...
          <div>
            ...
            <input
              type="email"
              className=" appearance-none py-4 bg-transparent border-b border-teal-500 w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none"
          ...
          <button
            className="w-full mb-4 text-[18px] mt-6 p-2 rounded-full bg-white text-emerald-800 hover:bg-teal-600 hover:text-white"
            type="submit"
          >
            Register
          </button>
