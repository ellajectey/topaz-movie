                ...
                {genres.map(genre => (
                    <div key={genre.id}>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
                            {groupedMovies[genre.id] && groupedMovies[genre.id].map(movie => (
                                <div key={movie.id} className="border  p-4 rounded-lg">
                                    <img src={`https://image.tmdb.org/t/p/w200${movie.poster_path}`} alt={movie.title} className="border border-black p-4 rounded-lgw-full h-auto rounded-md mb-2" />
